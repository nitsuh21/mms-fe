      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 md:col-span-3">
          <div className="rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark">
            <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Report Types</h2>
        ...
        <div className="col-span-12 md:col-span-9">
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="p-6">
              ...
              <div className="mb-6 h-80 rounded-lg border-2 border-dashed border-gray-200 flex items-center justify-center dark:border-gray-700">
              ...
              <div className="rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="grid grid-cols-4 border-b border-gray-200 py-3 px-4 dark:border-gray-700">
                  <div className="col-span-1 font-medium text-gray-900 dark:text-white">Category</div>
                  <div className="col-span-1 font-medium text-gray-900 dark:text-white">Value</div>
                  <div className="col-span-1 font-medium text-gray-900 dark:text-white">Change</div>
                  <div className="col-span-1 font-medium text-gray-900 dark:text-white">Trend</div>
                </div>
